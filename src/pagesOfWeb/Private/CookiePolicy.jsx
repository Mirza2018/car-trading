    ...
    <div className="container mx-auto p-8 bg-gray-50 rounded-lg ">
      ...
      <div className="mb-8">
        ...
        <p className="text-lg text-gray-600 leading-relaxed">
          ...
          accepterer et bud, er aftalen bindende mellem sælger og bilforhandler.
        </p>
      </div>
      ...
      <div className="mb-8">
        ...
        <p className="text-lg text-gray-600 leading-relaxed">
          Sælger er ansvarlig for, at alle oplysninger om bilen er korrekte, og
          at bilen er fri for gæld og hæftelser, medmindre andet er aftalt. Hvis
          bilens stand afviger væsentligt fra det oplyste, kan forhandler
