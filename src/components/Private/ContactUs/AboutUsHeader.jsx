      ...
      <div className="container mx-auto p-8 bg-gray-50 rounded-lg ">
        ...
        <div className="mb-8">
          ...
          <p className="text-lg text-gray-600 leading-relaxed">
            ...
            dermed har over 24 års erfaring. Gennem årene har vi arbejdet med
            køb, salg, import og eksport af biler og har opbygget en solid
            forståelse for bilmarkedet – både set fra den private sælgers og
            bilforhandlerens side.
          </p>
        </div>
        ...
        <div className="mb-8">
          ...
          <p className="text-lg text-gray-600 leading-relaxed mb-4">
            På baggrund af denne indsigt har vi udviklet engrosbasen – en
            platform skabt med det formål at gøre det nemt, professionelt og
            gennemsigtigt for private at sælge deres bil, samtidig med at
            bilforhandlere får direkte adgang til biler uden unødige mellemled.
          </p>
          <p className="text-lg text-gray-600 leading-relaxed mb-4">
        ...
        <div className="mb-8">
          ...
          <p className="text-lg text-gray-600 leading-relaxed">
            Vi samarbejder udelukkende med professionelle bilforhandlere,
            hvilket sikrer en seriøs og tryg handel for alle parter.
          </p>
        </div>
        ...
        <div className="mb-8">
          ...
          <p className="text-lg text-gray-600 leading-relaxed">
            ...
            engrosbasen er skabt ud fra praksis og mange års erfaring – ikke
            teori.
          </p>
        </div>
      </div>
