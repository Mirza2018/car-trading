  ...
  return (
    <div className="">
      <h1 className="text-[40px] font-semibold text-center">
        Total Car Buy ({displayedData?.data?.result?.length})
      </h1>
      <div className="flex flex-col gap-3 h-[450px] mt-3 overflow-scroll overflow-x-hidden scrollbar-hide">
        {displayedData?.data?.result?.slice(0, 3).map((car) => (
          ...
          >
            <React.Fragment>
              <div className="text-3xl font-bold flex justify-center items-center !w-32 uppercase bg-secondary-color py-[29px] px-5 rounded-xl">
                {/* <Image
