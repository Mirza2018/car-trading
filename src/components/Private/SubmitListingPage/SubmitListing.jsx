...
const carBrands = [
  ...
  { label: "Zenvo", value: "Zenvo" }, // Danish hypercar brand
  { label: "Hydrema", value: "Hydrema" }, // Danish utility vehicle brand
  ...
  { label: "Proton", value: "Proton" }, // Malaysian brand
  { label: "Hindustan Motors", value: "Hindustan Motors" }, // Indian brand
  { label: "Tata Motors", value: "Tata Motors" }, // Indian brand
  { label: "Mahindra", value: "Mahindra" }, // Indian brand
  { label: "Geely", value: "Geely" }, // Chinese brand
  { label: "NIO", value: "NIO" }, // Chinese electric vehicle brand
  { label: "XPeng", value: "XPeng" }, // Chinese electric vehicle brand
  { label: "Li Auto", value: "Li Auto" }, // Chinese electric vehicle brand
  { label: "Spyker", value: "Spyker" }, // Dutch niche brand
  { label: "Rimac", value: "Rimac" }, // Croatian electric hypercar brand
  { label: "VinFast", value: "VinFast" }, // Vietnamese brand
];
// const carModels = [
//   {
